...
//Efetuar a leitura de 5 valores inteiros e exibir na tela o menor e o maior deles. 
    ...
    nE := Val("Informe um ultimo numero: ")
    ...
    FwAlertInfo("O maior dos valores inseridos e:", +AllTrim(Str(nMex)))
    FwAlertInfo("O menor dos valores inseridos e:" + +AllTrim(Str(nMen)))
