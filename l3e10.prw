...
|--------------------------------------------------------------------------|
|--------------------------------------------------------------------------|
|E10– Desenvolva uma função que receberá um código de produto. Caso esse   |
|produto exista, calcule a média de quantidade desse item em pedidos de    |
|venda.                                                                    |
|--------------------------------------------------------------------------|
/*/
#INCLUDE 'TOTVS.CH'
